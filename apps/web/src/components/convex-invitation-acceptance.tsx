...
// The Convex-backed invitation acceptance page. Unchanged behavior, moved out
// of `invitation-acceptance.tsx` and off the deleted `lib/family-api.ts`
// (inlined below) so `app/invite/page.tsx` can pick a surface; i7 deletes
// this.
...
export function ConvexInvitationAcceptance() {
