...
// The Convex-backed settings page. Unchanged behavior, moved out of
// `app/(authenticated)/settings/page.tsx` verbatim so that page can pick a
// surface; i7 deletes this.
...
export function ConvexSettings() {
