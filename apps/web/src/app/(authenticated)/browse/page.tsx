// The browse page.
//
// The view, the history toggle and the type filter are the page's own
// `?view=&historical=&type=` query string, so the default render is one
// read-only transaction (`loadBrowse`). The thoughts tab's free-text search is
// not part of this query string -- see `lib/kith/browse.ts` and
