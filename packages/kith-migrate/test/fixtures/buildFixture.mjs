...
export function syntheticConvexTables() {
  const tables = {
    ...
    // P2-85's queue state, with the one-rewind marker migration 021 gave a
    // column after the first hosted rehearsal found it unmapped.
    cardExtractionQueueStates: [
      {
        ...
        phase: "idle",
        cursor: null,
        cursorRewoundAt: T0 + DAY,
        dailyDocumentBudget: 5,
        weeklyDocumentBudget: 20,
        weeklyCostBudgetMicroUsd: 1000000,
        dayWindowStart: T0,
        weekWindowStart: T0,
