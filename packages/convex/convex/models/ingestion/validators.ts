...
export const processingGenerationPayloadManifestFields = {
  spaceId: v.id("spaces"),
  sourceAccountId: v.id("sourceAccounts"),
  sourceItemId: v.id("sourceItems"),
  sourceRevisionId: v.id("sourceRevisions"),
  ...
  retainedTextHash: v.string(),
  retainedTextUtf8Length: v.number(),
  retainedTextUtf16Length: v.number(),
  manifestVersion: v.literal("parsed_payload_v1"),
  createdAt: v.number(),
};
