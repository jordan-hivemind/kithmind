...
//
// Read migration 032's header first: the owner's decision on 2026-09-19 is that
 ...
 * it from migration 032's column default, and every new one gets it from the
 ...
 *
 * One query against `kith.document_sensitivity` (migration 032), which is the
