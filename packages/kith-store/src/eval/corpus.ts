// P2-39g3: ported verbatim from
// packages/convex/convex/models/thoughts/memoryEval.corpus.ts.
//
// Every name, product, ticket and company below is synthetic -- "Avery",
// "Rowan", "Atlas Memory", "ATLAS-184", "Delgado Mechanical", "Foster
// Clarity" and the rest are fixture data, not a real person's or
// organization's record. That was true of the Convex original and is
// unchanged here (AGENTS.md's public contributor workflow: no real personal,
// family, health, financial, account, credential or production data in the
// repository).
//
// Seed corpus for the live recall baseline.
//
// Two accounts hold deliberately confusable memories -- the same child, the
// same product, the same kind of medical detail -- so that a broken account
// boundary produces a retrieval hit rather than silence.
//
